#ifndef SE_STRUCT_INTER_H
#define SE_STRUCT_INTER_H

#include "se_basic_math.h"

#define MAX_DIM 9

#define SU_HDR_SIZE 240
#define SEGY_HDR_SIZE 3200


// Seismic data structures

typedef struct segy_little_hdr_s
{
