...
#include <reference_global_gmres.hpp>
...
int main(int argc, char** argv)
{
    ...
    try {
        ...
        for (std::size_t iblock = 0; iblock < blocks.blocks.size(); ++iblock) {
            ...
            // Block zero is propagated analytically by phase_shift() below.
            // travel_time_solver therefore intentionally starts its files at
            // block 001, and no block_000 table should be opened here.
            if (!first_block) {
