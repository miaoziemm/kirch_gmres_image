...
GMRES_OUTER=30
GMRES_RESTART=30
GMRES_FREQUENCY_THREADS="${GMRES_FREQUENCY_THREADS:-32}"
...
BPACK_TOL="${BPACK_TOL:-1e-3}"
BPACK_LEAF="${BPACK_LEAF:-64}"
BPACK_DEPTH_CHUNK="${BPACK_DEPTH_CHUNK:-200}"
BPACK_LRLEVEL="${BPACK_LRLEVEL:-100}"
BPACK_SAMPLE_PARA="${BPACK_SAMPLE_PARA:-1.2}"
BPACK_FORWARD_N15="${BPACK_FORWARD_N15:-0}"
BPACK_KNN="${BPACK_KNN:-0}"
...
BPACK_GEOMETRY_CACHE_MB="${BPACK_GEOMETRY_CACHE_MB:-2048}"
